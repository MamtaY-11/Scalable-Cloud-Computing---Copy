...
def sort():
    try:
        ...
        api_url = f'https://cbptrd6kif.execute-api.eu-west-1.amazonaws.com/dev/x22245855Sorting?tableName={table_name}&sortBy={sort_key}&sortOrder={sort_order}'
...
#         else:
#             return jsonify({'message',{api_url}}), response.status_code
